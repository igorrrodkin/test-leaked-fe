...
const WorkspaceVerificationRow: FC<Props> = ({
  index,
  verifyResponses,
  elementId,
  render,
  ...
  useEffect(() => {
    if (verifyResponses && verifyResponses[index]) {
  ...
  return (
    <TR
      ...
      onClick={
        ...
        || (toRender.errorType === ErrorTypes.WARNING && toRender.information === 'Verification failed')
...
export default WorkspaceVerificationRow;
