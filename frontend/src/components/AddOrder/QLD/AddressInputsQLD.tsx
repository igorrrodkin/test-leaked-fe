    ...
    <>
      <StyledAddressInputs ref={inputsRef}>
        ...
        <Input
          ...
          placeholder={getInputPlaceholder.QLD.Address.streetName}
          inputMarginBottom="0"
        ...
        <Input
          ...
          labelColor="#1A1C1E"
          onChange={setSuburb}
          placeholder={getInputPlaceholder.QLD.Address.suburb}
          inputMarginBottom="0"
...
export default AddressInputsQLD;
